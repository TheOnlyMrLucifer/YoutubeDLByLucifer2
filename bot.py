...
async def start(client, message):
        ...
        try:
            ...
            if user.status == "kicked":
                await client.send_message(
                    ...
                    text=f"Sorry Sir, You are Banned to use me. ).",
                    parse_mode="markdown",
            ...
            await client.send_message(
                chat_id=message.chat.id,
                text="**Join My channel To access Bot 🔐**",
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "🔔Join Channel", url=f"https://t.me/PeriOfiGPeeksTango")
                        ]
                    ]
                ),
                parse_mode="markdown"
    ...
    joinButton = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton(
                    "🔔Contact Owner", url="https://t.me/TheOnlyMrLucifer"")
            ],
            [
                InlineKeyboardButton(
